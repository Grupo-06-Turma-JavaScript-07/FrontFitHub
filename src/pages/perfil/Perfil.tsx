...
function PerfilPlus() {
    ...
    // função que vai buscar o usuario no backend, funciona bem parecido com as funções de pegar o tema ou a produtos pelo ID
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="flex gap-8 mt-4 items-center">
                    ...
                    <div className="">
                        ...
                        <p className="font-semibold text-sky-900 text-lg">
                            Total de postagens: {usuarioLogado.produtos?.length}
                        </p>
                    </div>
                </div>
                ...
                {/* aqui em baixo, eu pego o Array de postagens que o usuário tem, por causa do relacionamento do backend, e rodo um map, pra poder gerar um card para cada produtos feita por esse usuário
        */}
                    ...
                    {usuarioLogado.produtos?.map((produtos) => (
                        <div className="border-2 rounded-lg overflow-hidden shadow-sky-900 shadow-md">
                            ...
                            <div className="px-2">
                                ...
                                <p className="text-sm">{produtos.texto}</p>
                                <p className="text-sm">
                                    data:{' '}
                                    ...
                                    }).format(new Date(produtos.data))}
                                </p>
                            </div>
                            <div className="flex w-full text-white font-semibold">
                                <Link
                                    to={`/editarProdutos/${produtos.id}`}
